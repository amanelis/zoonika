...
1) To invoke the sentiment analysis functions to analyze tweets (or sentences of your choice) simply follow the code below in the sent.php file in the root
  $search = 'avatar';
  $result = 100;
